...
PROTEGES="$RACINE/sites-clients $RACINE/taches $RACINE/appels $RACINE/carte $RACINE/partage $RACINE/a-envoyer $RACINE/cta $RACINE/cockpit $RACINE/tournage $RACINE/layouts"

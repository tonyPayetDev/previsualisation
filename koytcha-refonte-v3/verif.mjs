// Contrôle des six correctifs v3, dans un vrai navigateur.
...
//
//   node verif.mjs http://127.0.0.1:8834/koytcha-refonte-v3/
...
const url = process.argv[2] || 'https://previsualisation.automatisationboost.com/koytcha-refonte-v3/';
const ok = (b) => (b ? '✓' : '✗');

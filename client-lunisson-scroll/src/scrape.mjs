...
const url = 'https://www.restaurant-lunisson.re/';
let statut = 0;
try {
...
fs.writeFileSync('/work/previsualisation/client-lunisson-scroll/src/releve.json', JSON.stringify(releve, null, 1));
await p.screenshot({ path: '/work/previsualisation/client-lunisson-scroll/src/avant-pleine-page.jpg', fullPage: true, quality: 72, type: 'jpeg' });
await p.screenshot({ path: '/work/previsualisation/client-lunisson-scroll/src/avant-hero.jpg', quality: 80, type: 'jpeg' });
